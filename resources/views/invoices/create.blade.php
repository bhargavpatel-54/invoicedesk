...
<div class="row justify-content-center">
    <div class="col-lg-12">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <h4 class="fw-bold mb-0">Create New Sale Invoice</h4>
                <p class="text-muted small mb-0">Fill in the details to generate a professional GST invoice.</p>
            </div>
                                ...
                                <table class="table table-borderless align-middle mb-0" id="itemsTable">
                                    ...
                                    <tbody id="invoiceItems">
                                        ...
                                        <tr class="item-row border-bottom">
                                            ...
                                            <td class="py-3">
                                                <input type="number" name="items[0][quantity]" class="form-control qty-input" value="1" step="0.001" required>
                                            </td>
                                            <td class="py-3">
                    ...
                    <div class="card border-0 shadow-sm card-dashboard h-100">
                        <div class="card-body p-4">
                            <div class="mb-4">
                                ...
                                <textarea name="notes" class="form-control" rows="3" placeholder="Will be visible on the invoice..."></textarea>
                            </div>
                            <div>
                                <label class="form-label fw-semibold small text-muted">Terms & Conditions</label>
                                <textarea name="terms_conditions" class="form-control" rows="3" placeholder="Payment terms, return policy, etc...">1. Goods once sold will not be taken back.
                    ...
                    <div class="card border-0 shadow-sm card-dashboard">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="fw-bold" id="totalSubtotal">₹ 0.00</span>
                            </div>
                            ...
                            <div class="row g-2 align-items-center mb-2">
                                <div class="col-7">
                                    ...
                                    <div class="d-flex gap-2 mt-1">
                                        ...
                                        <input type="number" name="discount_value" id="discountValue" class="form-control form-select-sm" value="0" step="0.01">
                                    </div>
                                </div>
                            ...
                            <div class="mt-4">
                                <button type="submit" class="btn btn-primary w-100 py-3 fw-bold shadow">
                                    <i class="bi bi-save me-2"></i> SAVE & GENERATE INVOICE
                                </button>
                            </div>
                        </div>
                    </div>
